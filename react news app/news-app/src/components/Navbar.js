...
import logo2  from './news-crek-website-favicon-color.png';
export class Navbar extends Component {
  render() {
    return (
      <div>
        {/* <!-- component -->/ */}
<nav className=" bg-white text-gray-800 flex relative justify-between items-center mx-auto px-8 h-20 border-b-[2px]">
    {/* <!-- logo --> */}
    <div className="inline-flex">
        <a className="_o6689fn" href="/"
            ><div className="hidden md:block">
                <img src={logo} alt="" width="200" fill="currentcolor" style={{display: "block"}}/>
            </div>
            <div className="block md:hidden">
                <img src={logo2} alt="" width="50" fill="currentcolor" style={{display: "block"}}/>
            </div>
        </a>
    </div>
    ...
    {/* <!-- search bar --> */}
    <div className="hidden sm:block text-gray-800 flex-shrink flex-grow-0 justify-start px-2">
